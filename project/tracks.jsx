...
const ItemCard = ({ item, onOpenTimeline, onAct, flash }) => {
...
const TrackPreview = ({ items, onExpand, onAct }) => {
  ...
  // Show up to 3 highest-urgency items as preview rows
...
const Track = ({ trackId, title, accent, items, stages, owner,
...
Object.assign(window, { StageRail, ItemCard, Track, TrackPreview });
