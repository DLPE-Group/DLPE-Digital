/* ============================================================
   ...
   Mirrors the real nango.openConnectUI() flow:
   list → consent (OAuth / API-key) → connecting popup → success.
   No backend: the OAuth round-trip and key validation are
   simulated, but every screen reflects the genuine experience.
   ============================================================ */
...
const CATEGORY_ORDER = ['CRM', 'Accounting & Finance', 'ERP & Supply chain', 'Productivity & Comms'];
...
/* ---- The widget ---- */
const NangoConnect = ({ onClose, onConnected }) => {
...
Object.assign(window, { NangoConnect, NANGO_PROVIDERS });
