/* ============================================================
   ...
   Runs AFTER Nango establishes the connection. Nango handles
   auth + transport; this is where the AI reads the source's
   raw schema, maps it onto the unified DataSource model, and
   lets you author ETL-style transforms in plain language
   (concat / compute / format across multiple fields).
   ============================================================ */

/* Per-category: the 1:1 auto-matches + the fuller raw field
   pool the transform composer can draw on. */
...
const generateTransform = async (instruction, provider, fields) => {
...
const AiMappingFlow = ({ provider, onClose, onComplete }) => {
...
Object.assign(window, { AiMappingFlow, MAPPING_PROFILES, generateTransform });
