/* ============================================================
   PipelineBoard — kanban view of a track. Drag cards between
   stage columns; dropping calls onMoveStage(itemId, stageId).
   ============================================================ */
...
const PipelineBoard = ({ items, stages, onAct, onMoveStage }) => {
  const [dragId, setDragId] = React.useState(null);
  const [overStage, setOverStage] = React.useState(null);

  // active index for marking columns done/active
